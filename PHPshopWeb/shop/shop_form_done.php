...
?>
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>ベトナム農園</title></head>
<body>
...
$max=count($cart);
/*
$dsn='mysql:dbname=shop;host=localhost;port=1234;charset=utf8';
$user='root';
$password='';
...
$honbun.="ベトナム農園銀行 やさい支店 普通口座 １２３４５６７\n";
...
$honbun.="メール congnhan@gmail.com\n";
$honbun.="□□□□□□□□□□□□□□\n";
//print '<br />';
//print nl2br($honbun);

$title='ご注文ありがとうございます。';
$header='From:congnhan@gmail.com';
...
mb_language('Japanese');
mb_internal_encoding('UTF-8');
mb_send_mail('congnhan@gmail.com',$title,$honbun,$header);
